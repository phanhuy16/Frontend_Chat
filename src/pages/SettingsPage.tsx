  ...
  return (
    <div className="flex-1 flex gap-0 lg:gap-4 overflow-hidden h-full">
      ...
      <aside className="hidden md:flex flex-col w-full max-w-[280px] lg:max-w-[320px] glass-effect lg:rounded-3xl shrink-0 overflow-hidden p-6 transition-all duration-300">
        <div className="flex flex-col justify-between h-full">
          <div className="flex flex-col gap-8">
            {/* User Info Card */}
            <div className="flex gap-4 items-center p-4 rounded-2xl bg-slate-100/50 dark:bg-white/5 border border-white/20 dark:border-white/10 shadow-premium">
              <div
                className="bg-center bg-no-repeat aspect-square bg-cover rounded-xl size-12 shadow-lg border-2 border-white dark:border-white/10"
                style={{
          ...
          <button
            ...
            className="flex items-center gap-3.5 px-4 py-3 rounded-2xl text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 transition-all font-bold group"
          >
      ...
      <main className="flex-1 overflow-y-auto glass-effect lg:rounded-3xl transition-all duration-500 relative bg-white/30 dark:bg-transparent">
        <div className="p-8 lg:p-16 mx-auto max-w-4xl">
